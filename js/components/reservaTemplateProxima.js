//reservaTemplate.js
export function reservaTemplateProxima(prefix = "") {
    ...
    <div class="p-4 space-y-4">
      ...
      <div class="bg-accordion border border-gray-600 rounded-lg shadow-sm">
        <button onclick="toggleAccordion('vehicle', '${prefix}')" class="w-full p-4 flex items-center justify-between rounded-t-lg accordion-hover">
          ...
          <svg id="${p('vehicle-arrow')}" class="w-5 h-5 text-gray-400 accordion-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="px-4 pb-4 space-y-4">
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <p id="${p('vehicle-brand-model')}" class="font-medium text-white">-</p>
              </div>
              <div>
                <span class="text-sm text-gray-400">Año</span>
                <p id="${p('vehicle-year')}" class="font-medium text-white">-</p>
              </div>
              <div>
                <span class="text-sm text-gray-400">Patente</span>
                <p id="${p('vehicle-plate')}" class="font-medium text-white">-</p>
              </div>
              <div>
                <span class="text-sm text-gray-400">Precio/hora</span>
                <p id="${p('vehicle-price')}" class="font-bold text-green-400">-</p>
              </div>
            </div>
            <div class="flex items-center justify-between py-2 border-t border-gray-600">
              <span class="text-sm text-gray-300">Asientos</span>
              <span id="${p('vehicle-seats')}" class="font-medium text-white">-</span>
            </div>
            <div class="flex items-center justify-between py-2">
              <span class="text-sm text-gray-300">Transmisión</span>
              <span id="${p('vehicle-transmission')}" class="font-medium text-white">-</span>
            </div>
            <div class="flex items-center justify-between py-2">
              <span class="text-sm text-gray-300">Categoría</span>
              <span id="${p('vehicle-category')}" class="font-medium text-white">-</span>
            </div>
      ...
      <div class="bg-accordion border border-gray-600 rounded-lg shadow-sm">
        <button onclick="toggleAccordion('reservation', '${prefix}')" class="w-full p-4 flex items-center justify-between rounded-t-lg accordion-hover">
          ...
          <svg id="${p('reservation-arrow')}" class="w-5 h-5 text-gray-400 accordion-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
          </svg>
        </button>
            ...
            <div class="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
              <div class="flex items-start gap-3 mb-2">
                ...
                <div class="flex-1">
                  ...
                  <h5 id="${p('pickup-office-name')}" class="font-semibold text-white">-</h5>
                </div>
              </div>
              <div id="${p('pickup-office-details')}" class="ml-8 space-y-2 text-gray-300 text-sm hidden">
            ...
            <div class="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
              <div class="flex items-start gap-3 mb-2">
                ...
                <div class="flex-1">
                  ...
                  <h5 id="${p('dropoff-office-name')}" class="font-semibold text-white">-</h5>
                </div>
              </div>
              <div id="${p('dropoff-office-details')}" class="ml-8 space-y-2 text-gray-300 text-sm hidden">
                <div class="flex items-start gap-2">
                  <span class="material-icons text-gray-300 text-base">place</span>
            ...
            <div class="border-t border-gray-600 pt-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p id="${p('res-date-start')}" class="font-medium text-white">-</p>
                  <p id="${p('res-time-start')}" class="text-sm text-gray-300">-</p>
                </div>
                <div>
                  <span class="text-sm text-gray-400">Fin</span>
                  <p id="${p('res-date-end')}" class="font-medium text-white">-</p>
                  <p id="${p('res-time-end')}" class="text-sm text-gray-300">-</p>
                </div>
              </div>
            </div>
            ...
            <div class="border-t border-gray-600 pt-4">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p id="${p('res-date-real-start')}" class="font-medium text-gray-500">-</p>
                  <p id="${p('res-time-real-start')}" class="text-sm text-gray-500">-</p>
                </div>
                <div>
                  <span class="text-sm text-gray-400">Devolución Real</span>
                  <p id="${p('res-date-real-end')}" class="font-medium text-gray-500">-</p>
                  <p id="${p('res-time-real-end')}" class="text-sm text-gray-500">-</p>
                </div>
              </div>
            </div>
          </div>
