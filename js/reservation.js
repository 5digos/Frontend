    ...
    if (!modal) {
      ...
      modal.innerHTML = `
        <div class=\"modal-overlay\" style=\"position:fixed;z-index:1000;top:0;left:0;width:100vw;height:100vh;background:rgba(20,20,20,0.85);display:flex;align-items:center;justify-content:center;\">
          <div class=\"modal-content\" style=\"background:var(--bg-main,#18181b);padding:2rem 1.5rem;border-radius:1rem;max-width:90vw;min-width:300px;text-align:center;box-shadow:0 2px 16px #0008;border:1px solid #444;\">
            <h2 style=\"font-size:1.2rem;font-weight:bold;margin-bottom:1rem;color:#fff;\">¿Desea crear una nueva reserva?</h2>
